...
export function LoginComponent() {
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm<TLoginInput>({ resolver: yupResolver(loginSchema) });

  const handleLoginSubmit: SubmitHandler<TLoginInput> = (data: TLoginInput) =>
  ...
  return (
    <section className="">
      <form
        ...
        className="bg-indigo-50 px-7 py-7 sm:px-10  text-slate-800 rounded-2xl justify-self-center"
        aria-label="sigin-form"
      >
        ...
        <div className="inputs">
          <div className="form-group">
            ...
            />
            {errors.loginEmail && (
              <span className="text-xs text-start px-2 bg-red-300 rounded-sm">
